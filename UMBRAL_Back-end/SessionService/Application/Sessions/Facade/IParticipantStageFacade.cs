...
/// (repositorio de sesiones, TeamService y StageService) y el detalle de ocultar
/// el campo <c>IsCorrect</c> de las opciones, que los participantes nunca deben ver.
/// </summary>
public interface IParticipantStageFacade
{
    ...
    /// arrancado) y "Completed" (equipo pasó la última etapa), y auto-arranca al
    /// equipo cuando la sesión está en curso. Falla con
