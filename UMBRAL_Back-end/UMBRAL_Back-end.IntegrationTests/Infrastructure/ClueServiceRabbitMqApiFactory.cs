...
/// <summary>Level-2: ClueService wired to a real Testcontainers RabbitMQ broker.</summary>
public class ClueServiceRabbitMqApiFactory(string connectionString, string rabbitMqConnectionString)
    : RabbitMqBackedApiFactory<ClueProgram, CluesDbContext>(connectionString, rabbitMqConnectionString);
